...
void main(void)
{
    ...
    // ADC10CLK = SMCLK/8 = 8MHz/8 = 1MHz
    // Control Register 0
    ADC10CTL0 |= BIT12; // Sample&hold time = 16 * ADC10CLK = 16/1MHz = 16 us
    ...
    while(1)
    {
        ...
        ADC10CTL1 &= ~(0xF000);         // Clear channel mux bits: BIT15 - BIT12
        ADC10CTL1 |= INCH_5;            // Multiplex the analog channel 5
